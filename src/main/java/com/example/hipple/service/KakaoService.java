...
import com.example.hipple.dto.KakaoTokenDto;
...
public class KakaoService {
    ...
    public String getAccessToken(String code) {
        ...
        KakaoTokenDto kakaoTokenResDto = WebClient.create(KAUTH_TOKEN_URL_HOST).post()// 카카오 인증 서버로 post 요청 준비
                ...
                .bodyToMono(KakaoTokenDto.class) // 카카오 서버로부터 받아온 응답 본문을 우리가 만든 dto로 변환
